...
import { parseNativeAssetAmount, formatNativeAssetAmount, addZeroToDecimalPosition } from 'utility/buildInOutDisplay'
  ...
  componentDidMount() {
    if(this.props.fieldProps.value){
      ...
      this.props.fieldProps.onChange(
        parseNativeAssetAmount(value, this.props.decimal )
      )
      ...
      <div className='form-group'>
        {this.props.title && <FieldLabel>{this.props.title}</FieldLabel>}
          <input className='form-control'
            type={'text'}
            {...fieldProps}
            value={formatNativeAssetAmount(this.state.value, this.props.decimal)}
